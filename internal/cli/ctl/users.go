...
`,
					...
					Subcommands: []*cli.Command{
						{
							...
							Action: func(ctx *cli.Context) error {
								...
								defer closeIfNeeded(be)
								if err := be.SetTurnEnabled(true); err != nil {
									return err
								}
								fmt.Println("TURN server is now ENABLED")
								return nil
							},
						},
						{
							Name:  "off",
							Usage: "Disable TURN server",
							Flags: []cli.Flag{
								&cli.StringFlag{
									Name:    "cfg-block",
									Usage:   "Module configuration block to use",
							...
							Action: func(ctx *cli.Context) error {
								...
								defer closeIfNeeded(be)
								if err := be.SetTurnEnabled(false); err != nil {
									return err
								}
								fmt.Println("TURN server is now DISABLED")
								return nil
							},
						},
						{
							Name:  "status",
							Usage: "Show TURN server status",
							Flags: []cli.Flag{
								&cli.StringFlag{
									Name:    "cfg-block",
									Usage:   "Module configuration block to use",
							...
							Action: func(ctx *cli.Context) error {
								...
								defer closeIfNeeded(be)
								enabled, err := be.IsTurnEnabled()
								if err != nil {
									return err
								}
								if enabled {
									fmt.Println("TURN server is ENABLED")
								} else {
									fmt.Println("TURN server is DISABLED")
								}
								return nil
							},
						},
				...
				{
					Name:  "logging",
					Usage: "Manage server logging status",
					Subcommands: []*cli.Command{
						{
							Name:  "on",
							...
							Action: func(ctx *cli.Context) error {
								...
								defer closeIfNeeded(be)
								if err := be.SetLoggingDisabled(false); err != nil {
									return err
								}
								fmt.Println("Logging is now ENABLED (requires restart or signal to take effect for all modules)")
								return nil
							},
						},
						{
							...
							Action: func(ctx *cli.Context) error {
								...
								defer closeIfNeeded(be)
								if err := be.SetLoggingDisabled(true); err != nil {
									return err
								}
								fmt.Println("Logging is now DISABLED")
								return nil
							},
						},
						{
							Name:  "status",
							Usage: "Show logging status",
							Flags: []cli.Flag{
								&cli.StringFlag{
									Name:    "cfg-block",
									Usage:   "Module configuration block to use",
							...
							Action: func(ctx *cli.Context) error {
								...
								defer closeIfNeeded(be)
								disabled, err := be.IsLoggingDisabled()
								if err != nil {
									return err
								}
								if disabled {
